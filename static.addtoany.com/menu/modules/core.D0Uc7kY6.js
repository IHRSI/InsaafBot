...
let A = navigator.userAgent,
    ...
    ue = () => {
        let e;
        var a = "share1";
        return e = (e = (e = (e = Z.native && navigator.share ? (e = -1 < A.indexOf("Mac") && a) || -1 < A.indexOf("CrOS") && "share2" : e) || !!/iPhone|iPad|iPod/.test(A) && a) || !!(-1 < A.indexOf("Mac") && R) && a) || !!/Android/i.test(A) && "share2", ue = () => e, e
    },
    $ = {
        page: {
            most: [
    ...
    ee = ((ce = $.page.most.concat($.feed.most)).forEach(e => i.push(e[2])), {
        apple_music: {
            name: "Apple Music",
            icon: "apple_music",
            color: "fa233b"
...
let k = e => setTimeout(e, 0),
    ...
    W = function(o) {
        ...
        let l = "a2a" + r,
            ...
            t, n = e => {
                var e = e.altKey,
                    t = Z.native,
                    t = (D || R) && (t === X || !0 === t) || !0 === t && navigator.share;
        ...
        e = () => {
            var e;
            ue() || (e = !!(e = Z.exclude_services) && 9 < e.length, U(r) || e || (ea = !1), Re(r)), a.destroy(), d.destroy()
        };
        let a = ne(i, "focus", e),
            d = ne(i, "mouseenter", e);
    ...
    q = (c, d) => {
        ...
        for (let s = 0; s < i; s++) {
            ...
            let r, l;
            if (_ = "", f = {}, L ? (d.target = T, ae(p, d), e = "a2a", n = "0166FF", D = ue(), t = "page" === p && D ? D : "a2a", i = H, 0 <= y.indexOf("a2a_floating_style") && (T.a2a_floating = 1)) : "feed" == e || "print" == e ? a = "" : H && e && oe(e, R) ? i = !0 : e && oe(e, m) && (F[e](T, e), o = !0), e && !oe(e, ["google_plus", "stumbleupon"]) && !o) {
...
let Ae = function() {
    ...
    Re = (C.key_listener = X, function(e) {
        if (!$e[e]) {
            var a, t, n = "a2a" + e,
...
let qe = (e, a) => {
    ...
    Ze = function() {
        ...
        for (var e, a, t = _.sheet || _.styleSheet || {}, n = ("insertRule" in t), o = ("addRule" in t), i = ce.concat([
            ...
            var s = Z.static_server,
                ...
                d = s != u ? s + "/" : u + "/svg/";
            c.rel = "stylesheet", c.href = d + "icons.38.svg.css", O.appendChild(c)
        }
        Ze = p
    },
    Qe = !1,
    ...
    la = () => {
        var e, a, t;
        Qe || (t = Z.static_server, e = K.createElement("script"), a = K.getElementsByTagName("script")[0], t = t != u ? t + "/" : t + "/svg/", h && e.setAttribute("nonce", h), e.src = t + "icons.38.svg.js", a.parentNode.insertBefore(e, a), Qe = !0)
    },
    sa = [],
    ca = {
        add: e => {
